    ...
    def __init__(self, top=None):
        ...
        def sendChalan(event):
            ...
            try:
                ...
                self.yag.send(to='shekhar.nikhil@kgce.edu.in', subject="Traffic Rule Challan", contents=message, attachments=data[0])
                self.yag.close()
            ...
            with open(filename, 'w', newline='') as file:
                ...
                for file in listFiles:
                    try:
                        ...
                        # Write row to file
                        writer.writerow([helmet_status, lp_status, lp_number.upper(), num_passengers])
        ...
        self.Label1.configure(text='''Traffic Rules Violation Detection System''')
